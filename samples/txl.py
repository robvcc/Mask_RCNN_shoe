...
class Shoes():
    def __init__(self):
        ...
        # self.COCO_MODEL_PATH = os.path.join(self.ROOT_DIR, "logs/shape20191127T1318/mask_rcnn_shape_0070.h5")
    ...
    def detect(self):
        ...
        self.SHARP_MODEL_PATH="../logs/shape20191128T1619/mask_rcnn_shape_0025.h5"
        ...
        image = cv2.imread("../txl_data/image/4.png", 1)
